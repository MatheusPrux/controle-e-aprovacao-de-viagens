        ...
        {safeTrips.length === 0 ? (
          <div className="bg-white p-16 rounded-[2.5rem] border-2 border-dashed border-gray-100 text-center">
            <div className="w-20 h-20 bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-6">
               <i className="fas fa-truck-ramp-box text-3xl text-gray-200"></i>
            </div>
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="flex flex-col items-end gap-3">
                      <div className="text-right">
                         <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest block">Distância Percorrida</span>
                         <span className="text-2xl font-black text-indigo-600 tracking-tighter">{isNaN(kmCount) || kmCount < 0 ? 0 : kmCount} KM</span>
                      </div>
                  ...
                  {trip.adminComment && (
                    <div className="mt-6 p-4 bg-red-50 rounded-2xl border border-red-100 text-[11px] text-red-700 flex items-start italic leading-relaxed">
                      ...
                      <div><span className="font-black not-italic block uppercase text-[8px] opacity-60 mb-1">Atenção Administrativa:</span> "{trip.adminComment}"</div>
                    </div>
                  )}
                </div>
              </div>
